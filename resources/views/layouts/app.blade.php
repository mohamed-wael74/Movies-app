    ...
    <nav class="border-b border-gray-200">
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6">
            <ul class="flex flex-col md:flex-row items-center">
                ...
                <li class="md:ml-6 my-1">
                    <a href="{{ route('movies.index') }}" class=" text-white"> Movies</a>
                </li>
                <li class="md:ml-6 my-1">
                    <a href="{{ route('tv.index')}}" class=" text-white "> TV shows</a>
                </li>
                <li class="md:ml-6 my-1">
                    <a href="{{route('actors.index')}}" class=" text-white"> Actors</a>
                </li>
            </ul>
            <div class="items-center flex flex-col md:flex-row">
                <div class=" relative mt-3 md:mt-0 xl:ml-96">
                    <input wire:model.debounce.500ms="search" type="text" placeholder="Search"
                        class=" bg-gray-600 rounded-full w-64 px-4 py-1 focus:outline-none focus:shadow-outline">
                ...
                <div class="md:ml-4 mt-2 md:mt-0">
                    <a href="#">
                        <img src="{{asset('img/Amazing-Profile-Picture.jpg')}}" alt="avatar" class="rounded-full w-8 h-8">
                    </a>
                </div>
            </div>
        </div>
